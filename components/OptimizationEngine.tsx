...
const Icons = {
    Brain: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[#3B82F6]"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z" /><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z" /><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4 4.5 4.5 0 0 1-3-4" /></svg>,
    ...
    if (loading) {
        return (
            <div className="bg-[#111827] border border-[#1F2937] rounded-3xl p-8 mb-8 flex items-center justify-center gap-4 shadow-sm">
                ...
                <p className="text-[#9CA3AF] font-medium text-xs animate-pulse">Running optimization engine...</p>
            </div>
        )
    }
        ...
        <div className="bg-[#111827] border border-[#1F2937] rounded-3xl p-8 lg:p-10 mb-10 shadow-sm relative overflow-hidden flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 animate-fade-in-up">
            <div className="relative z-10 flex-1">
                ...
                <p className="text-[#9CA3AF] font-medium text-sm mt-3 max-w-2xl">
                    Based on predictive forecasting, the 30-day demand for <strong className="text-[#F9FAFB] font-semibold">{recommendation.product}</strong> at <strong className="text-[#F9FAFB] font-semibold">{recommendation.warehouse}</strong> is expected to hit <strong className="text-[#3B82F6] font-semibold">{recommendation.predictedDemand} units</strong>. Current reserves sit at <strong className="text-rose-400 font-semibold">{recommendation.currentStock}</strong>.
                </p>
            </div>
            ...
            <div className="bg-[#111827] border border-[#1F2937] px-8 py-6 rounded-3xl text-center shadow-sm shrink-0 w-full lg:w-auto relative z-10 hover:border-[#374151] transition-all duration-300">
                ...
                <p className="text-3xl font-semibold text-[#F9FAFB] mb-6 mt-2">
                    {recommendation.reorderQuantity} <span className="text-sm text-[#9CA3AF] font-medium">Units</span>
                </p>
                <button
                ...
                >
                    {isApproving ? <div className="w-4 h-4 border-2 border-white/30 border-t-white rounded-full animate-spin"></div> : (
                        <>
