    ...
    <div className="min-h-screen bg-[#0B0F14] flex items-center justify-center p-4 relative overflow-hidden font-sans selection:bg-[#3B82F6]/30 selection:text-[#F9FAFB]">
      ...
      <div className="bg-[#111827] p-10 rounded-2xl w-full max-w-md shadow-sm border border-[#1F2937] relative z-10 animate-fade-in-up">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-semibold mb-2 text-[#F9FAFB]">
            Zypher
          </h1>
        ...
        <form onSubmit={isNewUser ? handleSignUp : handleLogin} className="space-y-5">
          {isNewUser && (
            <div className="space-y-1 text-left">
              <label className="text-xs font-semibold text-[#9CA3AF] ml-1">Company Name</label>
              <input
                type="text"
          ...
          <div className="space-y-1 text-left">
            <label className="text-xs font-semibold text-[#9CA3AF] ml-1">Email Address</label>
            <input
              type="email"
          ...
          <div className="space-y-1 text-left">
            <label className="text-xs font-semibold text-[#9CA3AF] ml-1">Password</label>
            <input
              type="password"
              placeholder="••••••••"
              required
          ...
          <button
            disabled={loading}
            className="w-full bg-[#3B82F6] hover:bg-[#2563EB] text-white py-3 rounded-lg font-semibold text-sm transition-all shadow-sm active:translate-y-[1px] disabled:opacity-50 mt-4 flex justify-center items-center gap-3"
          >
            {loading ? (
              <>
